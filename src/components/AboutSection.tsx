const AboutSection = () => {
  ...
  return <section className="bg-slate-800 p-8 lg:p-12 min-h-[50vh] flex flex-col justify-center border-r border-slate-700">
      ...
      <div className="flex flex-wrap gap-4">
        {technologies.map((tech, index) => <div key={index} className="bg-slate-700 px-4 py-2 rounded-lg border border-slate-600 hover:border-blue-400 transition-colors duration-300">
